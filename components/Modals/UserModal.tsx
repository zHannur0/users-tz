...
const UserModal: React.FC<UserModalProps> = ({ setShowModal, user }) => {
    return (
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    <div className="relative p-4 sm:p-6 space-y-[10px]">
                        ...
                        <div className="flex flex-col gap-[5px] pl-4 overflow-auto scrollbar-hide">
                            ...
                            {user?.answers && user.answers?.length < 1 ? user?.answers.map((answer) => {
                                const question = questions.find((q: Question) => q.id === answer.question);
                                return question ? (
                                    <div key={answer._id}>
                                ...
                                <div>User do not have answers</div>
                            )}
                        </div>
                    </div>
